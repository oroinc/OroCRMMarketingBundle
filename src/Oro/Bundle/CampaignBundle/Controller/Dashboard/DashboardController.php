...
class DashboardController extends AbstractController
{
     ...
     */
    public function campaignLeadsAction(Request $request, $widget): array
    {
        ...
        $items = $this->get(CampaignDataProvider::class)
            ->getCampaignLeadsDataResults($dateRange, $hideCampaign, $maxResults);
     ...
     * @throws InvalidConfigurationException
     */
    public function campaignOpportunityAction(Request $request, $widget): array
    {
        $widgetConfigs = $this->get(WidgetConfigs::class);
        $widgetOptions = $widgetConfigs->getWidgetOptions($request->query->get('_widgetId', null));
        $dateRange = $widgetOptions->get('dateRange');
        ...
        $items = $this->get(CampaignDataProvider::class)
            ->getCampaignOpportunitiesDataResults($dateRange, $maxResults);
     ...
     * @throws InvalidConfigurationException
     */
    public function campaignByCloseRevenueAction(Request $request, $widget): array
    {
        $widgetConfigs = $this->get(WidgetConfigs::class);
        $widgetOptions = $widgetConfigs->getWidgetOptions($request->query->get('_widgetId', null));
        $dateRange = $widgetOptions->get('dateRange');
        ...
        $items = $this->get(CampaignDataProvider::class)
            ->getCampaignsByCloseRevenueDataResults($dateRange, $maxResults);
